...
def generate_and_post():
    ...
    ВАЖЛИВО: У самому HTML-коді використовуй ТІЛЬКИ одинарні лапки для атрибутів (наприклад, <div style='color:red'>), 
    щоб не ламати JSON. Уникай використання подвійних лапок всередині тексту.
